! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).sa = e() }(this, (function() {
    ...
    class xt extends W {
        constructor(t, e) { super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = z.findOne(".slidergeser-indicators", this._element), this._addEventListeners(), this._config.ride === vt && this.cycle() }
        static get Default() { return Ct }
        static get DefaultType() { return Ot }
        static get NAME() { return "slidergeser" }
        next() { this._slide(at) }
        ...
        _addTouchEventListeners() {
            for (const t of z.find(".slidergeser-item img", this._element)) N.on(t, gt, (t => t.preventDefault()));
        ...
        _slide(t, e = null) {
            ...
            const l = n ? "slidergeser-item-start" : "slidergeser-item-end",
                c = n ? "slidergeser-item-next" : "slidergeser-item-prev";
    ...
    })), N.on(window, _t, (() => { const t = z.find('[data-bs-ride="slidergeser"]'); for (const e of t) xt.getOrCreateInstance(e) })), m(xt);
    ...
    const Zn = new Set(["sanitize", "allowList", "sanitizeFn"]),
        ...
        as = { allowList: Vn, animation: !0, boundary: "clippingParents", kontainer: !1, customClass: "", delay: 0, fallbackPlacements: ["top", "right", "bottom", "left"], html: !1, offset: [0, 6], placement: "top", popperConfig: null, sanitize: !0, sanitizeFn: null, selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', title: "", trigger: "hover focus" },
        ls = { allowList: "object", animation: "boolean", boundary: "(string|element)", kontainer: "(string|element|boolean)", customClass: "(string|function)", delay: "(number|object)", fallbackPlacements: "array", html: "boolean", offset: "(array|string|function)", placement: "(string|function)", popperConfig: "(null|object|function)", sanitize: "boolean", sanitizeFn: "(null|function)", selector: "(string|boolean)", template: "string", title: "(string|element|function)", trigger: "string" };
    class cs extends W {
        constructor(t, e) {
        ...
        show() {
            ...
            const { kontainer: n } = this._config;
        ...
        _configAfterMerge(t) { return t.kontainer = !1 === t.kontainer ? document.body : r(t.kontainer), "number" == typeof t.delay && (t.delay = { show: t.delay, hide: t.delay }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), t }
    ...
    return R(ao), m(ao), { Alert: Q, Button: Y, slidergeser: xt, Collapse: Bt, pilihanmenu: qi, Modal: On, Offcanvas: qn, Popover: us, ScrollSpy: Es, Tab: Ks, Toast: ao, Tooltip: cs }
}));
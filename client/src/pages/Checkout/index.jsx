...
const Checkout = () => {
  return (
    <Container>
      ...
      <div className="text-gray-500 px-4">1Malam, 1Kamar</div>
      <div className="font-semibold px-4">Presidential Room</div>
      ...
      <div className="flex flex-col px-4 mx-5">
        ...
        <button
          type="Submit"
          className="w-full block h-24 px-10 mx-auto rounded-lg text-white font-semibold text-lg bg-blue-600 hover:bg-blue-700"
        >
          Checkout
        </button>
      </div>
